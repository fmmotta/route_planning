...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in actions:
            ...
            if a_node.prenodes.issubset(previous_s_level):
                ...
                # Add new action to this new level of actions
    ...
    def add_literal_level(self, level):
        ...
        for a_node in previous_a_level:
            for effect_node in a_node.effnodes:
                ...
                # Add new state to this new level of states
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        #simply check if one node negates the other
        return bool(
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        #check if a node negates another's preconditions
        return bool(
