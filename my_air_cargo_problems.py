...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        #Here we are going to get the possible actions (which satisfy the problems preconditions) that can be executed from the current state. This is based off of the example file.
        kb = PropKB()
    ...
    def result(self, state: str, action: Action):
        ...
        #It is necessary to evaluate the effects of each action to determine the fluent status when it is transported to the new state
...
def air_cargo_p2() -> AirCargoProblem:
    ...
    # List where the cargo and planes are not (negative prcond)
